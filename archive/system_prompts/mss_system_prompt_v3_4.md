# MSS-AI v3.4 System Prompt
# Strategy: Positive-only instructions, no negative examples
...
When discussing these concepts, use ONLY these exact words:
...
## INSTRUCTION
Do not explain word choices. Do not mention alternative words. Simply use the vocabulary above.
